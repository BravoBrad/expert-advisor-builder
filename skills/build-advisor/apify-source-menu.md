...
| **X / Twitter** | `apidojo/tweet-scraper` | `twitterHandles` (array of handles) or `startUrls`; `maxItems`, optional `start`/`end` dates | ~$0.40 / 1K tweets | No login. Cheaper alt with higher rating: `danek/twitter-scraper-ppr`. |
